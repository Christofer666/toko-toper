                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                          ...
                          if ($jumlah_user == 1) {
                            ...
                            if ($password_benar) {
                              ...
                              echo "<div class='mb-4 pb-3' style='font-weight: bold; font-size: 30px; text-align: center;'>Username atau password tidak valid</div>";
                            }
                          } else {
                            echo "<div class='mb-4 pb-3'style='font-weight: bold; font-size: 30px; text-align: center;'>Username tidak ditemukan</div>";
                          }
                        }
                        ?>
                        <!-- Akhir PHP Validasi -->
                  ...
                  <div class="card-back">
                    <div class="center-wrap">
                      <div class="section text-center">
                        <h4 class="mb-3 pb-3">Hayoo ngapain lihat belakang, kamu berharap disini ada sesuatu tentu saja tidak. Jangan lihat belakang bro, lanjutkan Loginnya bro.</h4>
                      </div>
                    </div>
                  </div>
                </div>
